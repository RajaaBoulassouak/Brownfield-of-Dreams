...
gh_user_1 = GhUser.create!(gh_id: 39357526, name: "RajaaBoulassouak", link: "https://github.com/RajaaBoulassouak", token: ENV['USER_GITHUB_TOKEN_1'], user_id: 1)
gh_user_2 = GhUser.create!(gh_id: 37811063, name: "andrewetobin", link: "https://github.com/andrewetobin", token: ENV['USER_GITHUB_TOKEN_1'], user_id: 2)