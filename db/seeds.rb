...
User.create!(email: 'user@example.com', first_name: 'Rajaa', last_name: 'McRajaaton', password:  "12345")
User.create!(email: 'me@example.com', first_name: 'Harper', last_name: 'McHarperton', password:  "12345", token: ENV['github_api_key'])